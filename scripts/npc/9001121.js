...
var infinity = "\t\t\t\t\t\t#r#eMapleInfinity#k Style Catalog#n\r\n";
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        ...
        if (selection == 0)
			...
			var msg =infinity +  "Which gender would you like to become?\t\t\t\t\t\t\t\t\t    The cost is #e#b10#k#n#i4021010#."
