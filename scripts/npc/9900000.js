    ...
    if (mode < 0)
        ...
        if (status == 0 && mode == 1) {
			if(cm.getPlayer().getLevel() < 10) {
				cm.sendOk("Hello, I am the Vote Point exchanger for #rMeomrya#k!\r\n\r\nI am sorry, but I can only exchange Vote Points for players #blevel 20 or over#k.");
				cm.dispose();
				return;
			}
			var outStr = "Hey, I'm the memory Vote Points Trader NPC#k!\r\n";
			outStr += "You currently have #g#c##k #t" + itemToUse + "# and #g" + vp + "#k Vote Points.#b\r\n\r\n";
			outStr += "#L0##eTrade Vote Points for Package\r\n";
			outStr += "#k\r\n#L30#How many Vote Points do i have?\r\n";
			outStr += "#k\r\n#L1#I would like to exchange 1 Vp  for "+ nxAmount + " NX Cash \r\n";
			outStr += "#k\r\n#L2#I would like to exchange 1 Vp  for Random Chair  #t for " + chairAmount + " Random Chair" + (chairAmount > 1 ? "s" : "") + "#\r\n";
			outStr += "#k\r\n#L3#How many Vote Points do i have?" + weaponAmount + " Maple Weapons#\r\n";
			outStr += "#k\r\n#L4#I would like to exchange 1 Vp #t" + itemToUse + "# for " + buffAmount + " #t" + buff1ID + "#s and " + buffAmount + " #t" + buff2ID + "#s#\r\n";
			outStr += "#k\r\n#L5#I would like to exchange 1 Vp #t" + itemToUse + "# for a " + hiredMerchantLength + " Day Hired Merchant#\r\n";
