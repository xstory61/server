...
var maps = [
/*BossMaps*/[100000005, 105070002, 105090900, 230040420, 280030000, 220080000, 240020402, 240020101, 801040100, 240060200, 610010005, 610010012, 610010013, 610010100, 610010101, 610010102, 610010103, 610010104, 541010100, 610030600, 270050100],
...
function warp(selection){
    if (status == 0)
		...
		cm.gainItem(4006001, 1000);
		cm.sendSimple("kay now fuck off");
		cm.dispose();
	} else if (status == 5) {
		cm.gainItem(4006000, 1000);
		cm.sendSimple("kay now fuck off");
		cm.dispose();
    }
}
